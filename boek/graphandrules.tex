...
These matched instances categorized into three scopes. The union of al the instances in the three scopes form all the matched instances. In some rules we don't need all the matched instances but only one or two scopes. The scopes are listed below.
